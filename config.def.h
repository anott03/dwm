...
static const char *dmenucmd[] = { "dmenu_run", "-m", dmenumon, "-fn", dmenufont, "-nb", bg, "-nf", white, "-sb", magenta, "-sf", bg, NULL };
...
static Key keys[] = {
  ...
  // dmenu scripts
	...
	{ MODKEY,                       XK_c,      spawn,          SHCMD("/home/amitav/.local/bin/configs")   },
  ...
  // quitting, locking, suspending
	{ MODKEY|ShiftMask,             XK_e,      quit,           {0} },
	{ MODKEY,                       XK_q,      spawn,          SHCMD("/home/amitav/.local/bin/lock") },
